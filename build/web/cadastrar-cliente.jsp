<%-- 
    ...
    Created on : 15 de set de 2022, 08:58:41
    Author     : User
--%>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  method = "post"  action = "CadastrarCliente">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="email" id="inputEmailAddress" type="email" aria-describedby="emailHelp" placeholder="Digite seu email" />
                                            </div>
                                            <!-- Form Row    -->
                                            <div class="row gx-3">
                                                <div class="col-md-6">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block" href="CadastrarCliente">Cadastrar-se</button>
                                        </form>
                                    </div>
